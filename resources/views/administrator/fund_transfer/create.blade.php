                        ...
                        <form action="{{route('fund.pay')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" name="recipient" class="form-control form-control-rounded" required
                                    placeholder="Enter Phone Number" value="{{old('reciepient')}}">
                                    ...
                                    @if ($errors->has('name'))
                                        <div class="alert alert-danger alert-dismissible" role="alert">
                                            ...
                                            <div class="alert-message">
                                                <span><strong>Error!</strong> {{ $errors->first('reciepient') }} !</span>
                                            </div>
                                        </div>
                                    @endif
                                </div>
