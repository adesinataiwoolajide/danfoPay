            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('vehicle.type.save')}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row ">
                                <div class="col-sm-12">
                                    ...
                                    placeholder="Enter The Vehicle Type Name" value="{{old('type_name')}}">
                                ...
                                <table id="default-datatable" class="table table-bordered">
                                    ...
                                    <tbody><?php
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$y}}
                                                <a href="{{route('vehicle.type.delete', $types->type_id)}}" class="btn btn-danger"
                                                     onclick="return(confirmToDelete());">
                                                <i class="fa fa-trash-o"></i>
                                                </a>
                                                <a href="{{route('vehicle.type.edit', $types->type_id)}}" class="btn btn-success"
