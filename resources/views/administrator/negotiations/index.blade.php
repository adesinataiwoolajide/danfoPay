                                ...
                                <div class="table-responsive">
                                    <table id="default-datatable" class="table table-bordered">
                                        ...
                                        <tbody><?php
                                            ...
                                            @foreach($car as $cares)
                                                @foreach (dOwnnerNego($cares->vehicle_id) as $negotiations)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&#8358;{{number_format($negotiations->amount)}}</td>
                                                            ...
                                                            @foreach (negoCustomer($negotiations->customer_id) as $item)
                                                                <td>{{$item->email}}</td>
                                                            @endforeach

                                                            @foreach (dOwnnerMoto($negotiations->vehicle_id) as $item)
