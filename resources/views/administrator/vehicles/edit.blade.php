            ...
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{route('vehicle.edit',$vehicle->vehicle_id)}}">Edit Vehicle</a>
                    </li>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('vehicle.update',$vehicle->vehicle_id)}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row ">
                                <div class="col-sm-3">
                                    ...
                                    placeholder="Enter The Owner Name" value="{{$owner->name}}" readonly>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    placeholder="Enter The Owner's Phone Number"  value="{{$owner->phone_number}}" readonly>
                                    <span style="color: red">** This Field is Required **</span>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    placeholder="Enter The Plate Number" minlength="9" maxlength="10" value="{{$vehicle->plate_number}}">
                                    <span style="color: red">** This Field is Required **</span>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    placeholder="Repeat The Brand" value="{{$vehicle->brand}}">
                                    <span style="color: red">** This Field is Required **</span>
                                    @if ($errors->has('brand'))
                                        <div class="alert alert-danger alert-dismissible" role="alert">
                                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select class="form-control form-control-rounded" name="type_id" required>
                                        <option value="{{$vehicle->type_id}}"> {{$vehicle->type->type_name}} </option>
                                        <option value=""> </option>
                                    ...
                                    <tbody><?php
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$y}}
                                                ...
                                                <a href="{{route('add.operator',$cars->vehicle_id)}}"
